...
function mayor(){
    ...
    if(num1 > num2){
        document.getElementById("resultado7").textContent = 
            "Resultado: El número " + num1 + " es MAYOR";

    } else if(num2 > num1){
        document.getElementById("resultado7").textContent = 
            "Resultado: El número " + num2 + " es MAYOR";
...
function factorial(){
    ...
    if(numero < 0){
        document.getElementById("resultado8").textContent = 
            "Factorial:  No existe factorial de números negativos";
        return; 
    }
    if(numero === 0){
...
function arreglo10(){
    ...
    for(let i = 0; i < 20; i++){
        let aleatorio = Math.floor(Math.random() * 101); // 0 a 100
    ...
    document.getElementById("todos10").textContent = 
        "Todos: " + numeros;
    document.getElementById("pares10").textContent = 
        "Pares: " + pares;
    document.getElementById("impares10").textContent = 
        "Impares: " + impares;
}
...
function arreglo11(){
    ...
    document.getElementById("original11").textContent = 
    ...
    document.getElementById("modificado11").textContent = 
        "Sin múltiplos de 3: " + sinMultiplos;
}
...
function triangulo(){
    ...
    if((a + b <= c) || (a + c <= b) || (b + c <= a)){
        document.getElementById("area12").textContent = 
            "Esos lados no forman un triángulo válido";
...
function calcularPalabras(){
    ...
    document.getElementById("palabras13").textContent = 
        "Palabras: " + palabras;
    document.getElementById("caracteres13").textContent = 
        "Caracteres por palabra: " + caracteres;
    document.getElementById("total13").textContent = 
        "Total caracteres oración: " + totalConEspacios;
}
...
function invertir(){
    ...
    document.getElementById("original14").textContent = 
        "Original: " + original;
    document.getElementById("algoritmo14").textContent = 
        "Invertido (FOR): " + invertidoFor;
    document.getElementById("reverse14").textContent = 
        "Invertido (.reverse()): " + invertidoReverse;
}
